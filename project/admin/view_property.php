...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Listingan dihapus!';
   }else{
      $warning_msg[] = 'Listingan telah dihapus!';
   }
...
<section class="view-property">
   ...
   <h1 class="heading">Detail Properti</h1>
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="flex">
         <div class="box">
            <p><i>Kamar Tidur :</i><span><?= $fetch_property['bedroom']; ?></span></p>
            <p><i>Kamar Mandi :</i><span><?= $fetch_property['bathroom']; ?></span></p>
         </div>
         <div class="box">
            <p><i>Jumlah Lantai :</i><span><?= $fetch_property['total_floors']; ?></span></p>
            <p><i>Status Properti :</i><span><?= $fetch_property['furnished']; ?></span></p>
            <p><i>Pembayaran Jangka Pendek :</i><span><?= $fetch_property['loan']; ?></span></p>
         </div>
      </div>
      <h3 class="title">Fasilitas Properti</h3>
      <div class="flex">
         <div class="box">
            <p><i class="fas fa-<?php if($fetch_property['lift'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Lift</span></p>
            <p><i class="fas fa-<?php if($fetch_property['security_guard'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Security</span></p>
            <p><i class="fas fa-<?php if($fetch_property['play_ground'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Play Ground</span></p>
            <p><i class="fas fa-<?php if($fetch_property['garden'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Taman</span></p>
            <p><i class="fas fa-<?php if($fetch_property['water_supply'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Air</span></p>
            <p><i class="fas fa-<?php if($fetch_property['power_backup'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Daya Cadangan</span></p>
         </div>
         <div class="box">
            <p><i class="fas fa-<?php if($fetch_property['parking_area'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Area Parkir</span></p>
            ...
            <p><i class="fas fa-<?php if($fetch_property['hospital'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Rumah Sakit</span></p>
            <p><i class="fas fa-<?php if($fetch_property['school'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Sekolah</span></p>
            <p><i class="fas fa-<?php if($fetch_property['market_area'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Supermarket</span></p>
         </div>
      </div>
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <input type="submit" value="Hapus properti" name="delete" class="delete-btn" onclick="return confirm('Hapus listingan ini?');">
      </form>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">properti tidak ditemukan! <a href="listings.php" style="margin-top:1.5rem;" class="option-btn">Ke listingan</a></p>';
   }
   ?>
