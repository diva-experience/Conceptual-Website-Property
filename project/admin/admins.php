...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Admin dihapus!';
   }else{
      $warning_msg[] = 'Admin sudah terhapus!';
   }
...
<section class="grid">
   ...
   <div class="box" style="order: -1;">
      <p>Nama : <span><?= $fetch_admins['name']; ?></p>
      <a href="update.php" class="option-btn">Update akun</a>
      <a href="register.php" class="btn">Registrasi baru</a>
   </div>
   <?php }else{?>
   <div class="box">
      <p>Nama : <span><?= $fetch_admins['name']; ?></p>
      <form action="" method="POST">
         ...
         <input type="submit" value="delete admin" onclick="return confirm('Hapus admin ini?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php } ?>
   <?php
   ...
   ?>
      <p class="empty">Belum ada admin yang ditambahkan!</p>
      <div class="box" style="text-align: center;">
      <p>cBuat admin baru</p>
