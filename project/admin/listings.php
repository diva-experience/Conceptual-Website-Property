...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $warning_msg[] = 'Listingan telah terhapus!';
   }
...
<section class="listings">
   ...
   <h1 class="heading">Semua Listingan</h1>

   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="cari properti..." maxlength="100" required>
   ...
   <div class="box">
      ...
      <p class="price"><i class="fa-solid fa-rupiah-sign"></i><?= $fetch_listing['price']; ?></p>
      ...
      <form action="" method="POST">
         ...
         <a href="view_property.php?get_id=<?= $listing_id; ?>" class="btn">Lihat properti</a>
         <input type="submit" value="Hapus Listing" onclick="return confirm('Hapus listingan ini?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php
         }
         ...
         echo '<p class="empty">Belum ada postingan</p>';
      }
   ?>
