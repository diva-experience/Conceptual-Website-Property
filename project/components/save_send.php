...
if(isset($_POST['save'])){
   if($user_id != ''){
      ...
      if($verify_saved->rowCount() > 0){
         ...
         $success_msg[] = 'Listing Disimpan!';
      }

   }else{
      $warning_msg[] = 'Silahkan Masuk Terlebih Dahulu!';
   }
}
...
if(isset($_POST['send'])){
   if($user_id != ''){
      ...
      if(($verify_request->rowCount() > 0)){
         $warning_msg[] = 'Request Telah Terkirim!';
      }else{
         ...
         $success_msg[] = 'Request Berhasil Terkirim!';
      }
