...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <a href="update.php" class="btn">Perbaharui Profil</a>
      </div>

      <div class="box">
         <h3>Filter Pencarian</h3>
         <p>Cari Properti Impian Mu</p>
         <a href="search.php" class="btn">Cari Sekarang</a>
      </div>
      ...
      <p>List Properti</p>
      <a href="my_listings.php" class="btn">Lihat Semua Listing</a>
      </div>
      ...
      <a href="requests.php" class="btn">Lihat Semua Request</a>
      </div>
      ...
      <p>Properti yang Terkirim</p>
      <a href="saved.php" class="btn">Lihat Semua Properti</a>
      </div>
