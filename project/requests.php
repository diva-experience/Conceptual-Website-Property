...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Request Berhasil Dihapus.';
   }else{
      $warning_msg[] = 'Request Sudah Terhapus!';
   }
...
<section class="requests">
   ...
   <h1 class="heading">Semua Pesan Request</h1>
   ...
   <div class="box">
      ...
      <p>Nomor : <a href="tel:<?= $fetch_sender['number']; ?>"><?= $fetch_sender['number']; ?></a></p>
      <p>Email : <a href="mailto:<?= $fetch_sender['email']; ?>"><?= $fetch_sender['email']; ?></a></p>
      <p>Perminaan Properti : <span><?= $fetch_property['property_name']; ?></span></p>
      <form action="" method="POST">
         <input type="hidden" name="request_id" value="<?= $fetch_request['id']; ?>">
         <input type="submit" value="Hapus Request" class="btn" onclick="return confirm('Hapus Request Ini?');" name="delete">
   ...
   <?php
      ...
      echo '<p class="empty">Kamu tidak punya request!</p>';
   }
   ?>
