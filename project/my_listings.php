...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Listingan Berhasil Dihapus!';
   }else{
      $warning_msg[] = 'Listingan Sudah Terhapus!';
   }
...
<section class="my-listings">
   ...
   <h1 class="heading">Listingan Saya</h1>
   ...
   <form accept="" method="POST" class="box">
      ...
      <div class="flex-btn">
         ...
         <input type="submit" name="delete" value="hapus" class="btn" onclick="return confirm('Hapus Listing Ini?');">
      </div>
      <a href="view_property.php?get_id=<?= $property_id; ?>" class="btn">lihat properti</a>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">Properti Belum Ditambah. <a href="post_property.php" style="margin-top:1.5rem;" class="btn">Tambah Baru</a></p>';
      }
      ?>
