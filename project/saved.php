   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         <div class="box">
            ...
            ?>
            <button type="submit" name="save" class="save"><i class="fas fa-heart"></i><span>Hapus dari Simpan</span></button>
            <?php
               }else{ 
            ?>
      ...
      <?php
               ...
               echo '<p class="empty">Belum ada propoerti yang ditambahkan! <a href="post_property.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
            }
         }
      }else{
         echo '<p class="empty">Belum ada properti yang disimpan! <a href="listings.php" style="margin-top:1.5rem;" class="btn">Cari Sekarang</a></p>';
      }
      ?>
