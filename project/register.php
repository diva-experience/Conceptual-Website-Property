...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Mari buat akun anda!</h3>
      <input type="tel" name="name" required maxlength="50" placeholder="Nama Anda" class="box">
      <input type="email" name="email" required maxlength="50" placeholder="Email" class="box">
      <input type="number" name="number" required min="0" max="9999999999" maxlength="10" placeholder="Nomor Aktif" class="box">
      <input type="password" name="pass" required maxlength="20" placeholder="Password" class="box">
      <input type="password" name="c_pass" required maxlength="20" placeholder="Konfirmasi Password" class="box">
      <p>Sudah punya akun? <a href="login.html">Login sekarang</a></p>
      <input type="submit" value="Regist Sekarang" name="submit" class="btn">
   </form>
