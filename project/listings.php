...
<section class="listings">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">Belum Ada Properti yang Ditambahkan! <a href="post_property.php" style="margin-top:1.5rem;" class="btn">Tambah Properti</a></p>';
      }
      ?>
